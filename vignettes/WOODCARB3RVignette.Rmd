...
Estimates of annual change in carbon in "products in SWDS" for current year t for _Variables 1B and 2B_ may be obtained using Equations \@ref(eq:six) through [10], which are provided below. 
