...
calculateswpdata <- function() {
    ...
    swpcalcdata$`Sawnwood Imports` <- sapply(yrs, function(y) {
        ...
        if (y > 1917 && y < 1950) {
            return((((h8(y, 5) + h8(y, 7)) * InceF5) + (h8(y, 6) * InceG5)) * 
                1000)
        }
        if (y > 1949 && y < 1965) {
            return(((u29(y, 5) * 1000 * InceF5) + (u29(y, 6) * InceG5 * 
                1000)) * 1000)
        }
        if (y > 1964 && y < 2021) {
            return(((h28(y, 5) * 1000 * InceF5) + (h28(y, 6) * InceG5 * 
                1000)) * 1000)
        }
        # if(y>2020 && y< 2051){
    ...
    swpcalcdata$`Sawnwood Exports` <- sapply(yrs, function(y) {
        ...
        if (y < 1950) {
            return((((h8(y, 14) + h8(y, 16)) * InceF5) + (h8(y, 15) * 
                InceG5)) * 1000)
        }
        if (y < 1965) {
            return((((u29(y, 8) * 1000 * InceF5) + (u29(y, 9) * 1000 * 
                InceG5)) * 1000))
        }
        if (y < 2021) {
            return(((h28(y, 8) * 1000 * InceF5) + (h28(y, 9) * 1000 * 
                InceG5)) * 1000)
        }
    })
    swpcalcdata$`Roundwood consumed for lumber and panels` <- sapply(yrs, 
        function(y) {
            if (y < 1950) 
                {
                  return((h3(y, 28) + h3(y, 31)) * (InceV5 * 0.8 + InceW5 * 
                    0.2) * 1000)
            ...
            if (y < 1965) 
                {
                  # u5$j, u5$o...u6$j, u6$o
                  return(1000 * ((u5(y, 7) + u5(y, 11)) * InceV5 + (u6(y, 
                    7) + u6(y, 11)) * InceW5))
                }  #J,O.. Lumber Production + plywood/veneer production, for HW and SW
            if (y < 2021) {
                return(1000 * ((h6(y, 7) + h6(y, 11)) * InceV5 + (h7(y, 
                  7) + h7(y, 11)) * InceW5))
            }
        })
    ...
    swpcalcdata$NSP.Production <- sapply(yrs, function(y) {
        if (y < 1950) {
            return(((inc1(y, 4) * InceE5) + (inc1(y, 9) * InceJ5) + 
                (inc1(y, 13) * InceO5)) * 1000)
        }
        if (y < 1965) {
            return(((u36(y, 3) * InceE5) + (u52(y, 2) * InceI5) + (u54(y, 
                1) * InceJ5) + (u53(y, 1) * InceO5)) * 1000)
        }
        if (y < 2021) {
            return(((h37(y, 3) * InceE5) + (h53(y, 2) * InceI5) + (h56(y, 
                1) * InceJ5) + (h53(y, 3) * InceK5) + h55(y, 1) * InceQ5) * 
                1000)
        }
    })
    swpcalcdata$NSP.Imports <- sapply(yrs, function(y) {
        ...
        if (y > 1934 && y < 1950) {
            return((((h3t20(y, 3) * InceE5) + (h3t21(y, 1) * InceR5))/1000) * 
                1000)
        }
        if (y > 1949 && y < 1954) {
        ...
        if (y > 1953 && y < 1963) {
            return(((u36(y, 6) * InceE5) + (u54(y, 2) * InceJ5) + (u53(y, 
                2) * InceO5)) * 1000)
        }
        if (y > 1962 && y < 1965) {
            return(((u36(y, 6) * InceE5) + (u52(y, 4) * InceI5) + (u54(y, 
                2) * InceJ5) + (u53(y, 2) * InceO5)) * 1000)
        }
        if (y > 1964 && y < 2021) {
            return(((h37(y, 6) * InceE5) + (h53(y, 4) * InceI5) + (h56(y, 
                2) * InceJ5) + (h55(y, 2) * InceQ5)) * 1000)
        }
    })
    
    swpcalcdata$NSP.Exports <- sapply(yrs, function(y) {
        ## lNSP
        if (y < 1916) {
            return(0)
        }
        ...
        if (y < 1935) {
            return((((h3t20(y, 8) * InceE5 + h3t21(y, 4) * InceR5)/1000) + 
                (u54(y, 3) * InceJ5) + (u53(y, 3) * InceO5)) * 1000)
        }
        if (y < 1950) {
            return((((h3t20(y, 8) + h3t21(y, 4))/1000 * InceE5) + (u54(y, 
                3) * InceJ5) + (u53(y, 3) * InceO5)) * 1000)
        }
        if (y < 1965) {
            return(((u36(y, 9) * InceE5) + (u54(y, 3) * InceJ5) + (u53(y, 
                3) * InceO5)) * 1000)
        }
        if (y < 2021) {
            return(((h37(y, 9) * InceE5) + (h53(y, 5) * InceI5) + (h56(y, 
                3) * InceJ5) + h55(y, 3) * InceQ5) * 1000)
        }
    })
    ###################### 
...
calcplacediu <- function(Years = 1900:2020, approach = c("Production", 
    ...
    if (approachtype == "Production") {
        placeIU[, 2:16] <- swpcalcdata[["Sawnwood Prod Special"]][Years - 
            (minyr - 1)] * fracsawnwood[Years - (minyr - 1), -16] + 
            swpcalcdata[["SP Prod Special"]][Years - (minyr - 1)] * 
                fracstrpanels[Years - (minyr - 1), -16] + swpcalcdata[["NSP Prod Special"]][Years - 
            (minyr - 1)] * fracnonstrpanels[Years - (minyr - 1), -16]
    } else if (approachtype == "Stock Change") {
        placeIU[, 2:16] <- swpcalcdata[["Sawnwood Consumption"]][Years - 
            (minyr - 1)] * fracsawnwood[Years - (minyr - 1), -16] + 
            swpcalcdata[["SP.Consumption"]][Years - (minyr - 1)] * fracstrpanels[Years - 
